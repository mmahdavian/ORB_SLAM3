...
////
  ros::Publisher pose_pub = n.advertise<geometry_msgs::PoseStamped>("orb_pose",10);
  ros::Publisher keyframe_pub = n.advertise<geometry_msgs::PoseStamped>("keyframe_pose",10);
  ros::Publisher cloud_pub = n.advertise<sensor_msgs::PointCloud>("point_cloud",10);  
